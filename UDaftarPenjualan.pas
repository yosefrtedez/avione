  ...
  if (notabel = 0) and (nogrid = 3) then begin
    ...
    with TZQuery.Create(Self)do begin
      ...
      if FieldValues['total']>0 then begin
        MessageDlg('Invoice Pemnjualan tidak dapat dihapus, karena barang telah terpakai oleh transaksi pembayaran / retur'#10#13'Hapus dulu transaksi pembayaran atau retur untuk Transaksi ini.',mtError,[mbOK],0);
        Free;
        Exit;
      end;
